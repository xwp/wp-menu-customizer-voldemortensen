...
= Core Patches =
Several improvements to the Customizer are also in the works as a part of this project, in the form of core patches. See <a href="http://make.wordpress.org/core/2014/07/08/customizer-improvements-in-4-0/">Customizer Improvements in 4.0</a>, and an upcomming Customizer Roadmap for details.
...
1. Visit the Customizer (Appearance -> Customize) to customize your menus (live previews are not yet functional, but your changes are saved).
