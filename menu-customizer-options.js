	...
	var customizeMenuOptions = {
		init : function() {
			...
			var button = '<a id="customizer-menu-screen-options-button" title="Menu Options" href="#"></a>',
				header = $( '#accordion-section-menus .accordion-sub-container .accordion-section:first' );
			title = header.find( '.accordion-section-title' ).append( button );
			$( '#screen-options-wrap' ).appendTo( title );
